#vve:_store
scoreboard players operation @s vve_state = vve_state int
scoreboard players operation @s vve_omega = vve_omega int
scoreboard players operation @s vve_vx = vve_vx int
scoreboard players operation @s vve_vy = vve_vy int
scoreboard players operation @s vve_vz = vve_vz int
