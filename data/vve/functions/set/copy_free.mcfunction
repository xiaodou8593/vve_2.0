...
execute store result storage math:io rec[0].temp.omega[0] float 0.0001 run scoreboard players get @s vve_omegax
execute store result storage math:io rec[0].temp.omega[1] float 0.0001 run scoreboard players get @s vve_omegay
execute store result storage math:io rec[0].temp.omega[2] float 0.0001 run scoreboard players get @s vve_omegaz