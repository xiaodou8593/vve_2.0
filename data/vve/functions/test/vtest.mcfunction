...
data modify storage math:io input set value {sub_cubes:[],friction:[0.99d,0.99d],gravity:0.0d,bounce:0.75d}
...
scoreboard players set @e[tag=test,limit=1] d 5000
scoreboard players set @e[tag=test,limit=1] h 10000
scoreboard players set @e[tag=test,limit=1] l 5000
scoreboard players set @e[tag=test,limit=1] dy -5000
tag @e[tag=test,limit=1] add vtest_movable
tag @e[tag=test,limit=1] add vtest_rotable
