...
scoreboard players operation 3vec_x int = vve_mcx int
scoreboard players operation 3vec_y int = vve_mcy int
scoreboard players operation 3vec_z int = vve_mcz int
...
#tellraw @a {"score":{"name":"vve_rmass","objective":"int"}}
