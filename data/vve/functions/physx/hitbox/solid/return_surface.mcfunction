...
execute store result storage math:io midpos_xyz[1] double 0.0001 run scoreboard players add midpos_y int 5125
...
data modify storage math:io surface_friction set value [0.75d,0.75d]
